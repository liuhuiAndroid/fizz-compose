...
private val LightColorPalette = FizzColors(
    brand = Shadow5,
...
private val DarkColorPalette = FizzColors(
    brand = Shadow1,
...
object FizzTheme {
    @Composable
    val colors: FizzColors
        get() = AmbientFizzColors.current
}

/**
 * Fizz custom Color Palette
 */
@Stable
class FizzColors(
...
private val AmbientFizzColors = staticAmbientOf<FizzColors> {
